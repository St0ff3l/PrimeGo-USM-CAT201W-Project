...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .btn-login:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(255, 59, 48, 0.3); }
...
<body>
    ...
    <div class="login-card">
        ...
        <div style="text-align: center; margin-top: 15px;">
            ...
            <a href="${pageContext.request.contextPath}/public/signup.jsp" style="color: #FF9500; text-decoration: none; font-weight: 600;">Sign Up</a>
        </div>
